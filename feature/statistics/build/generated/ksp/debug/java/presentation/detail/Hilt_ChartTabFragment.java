...
public abstract class Hilt_ChartTabFragment<VBinding extends ViewBinding> extends BaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChartTabFragment_GeneratedInjector) this.generatedComponent()).injectChartTabFragment(UnsafeCasts.<ChartTabFragment>unsafeCast(this));
    }
  }
