...
public abstract class Hilt_NowTabFragment<VBinding extends ViewBinding> extends BaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NowTabFragment_GeneratedInjector) this.generatedComponent()).injectNowTabFragment(UnsafeCasts.<NowTabFragment>unsafeCast(this));
    }
  }
