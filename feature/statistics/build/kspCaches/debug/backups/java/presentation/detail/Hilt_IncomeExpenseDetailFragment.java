...
public abstract class Hilt_IncomeExpenseDetailFragment<VBinding extends ViewBinding> extends BaseFragment<VBinding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_IncomeExpenseDetailFragment(
      Function3<? super LayoutInflater, ? super ViewGroup, ? super Boolean, ? extends VBinding> inflateMethod) {
    super(inflateMethod);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IncomeExpenseDetailFragment_GeneratedInjector) this.generatedComponent()).injectIncomeExpenseDetailFragment(UnsafeCasts.<IncomeExpenseDetailFragment>unsafeCast(this));
    }
  }
