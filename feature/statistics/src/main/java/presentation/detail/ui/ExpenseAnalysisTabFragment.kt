...
import presentation.detail.viewmodel.ExpenseAnalysisViewModel
...
class ExpenseAnalysisTabFragment : BaseFragment<FragmentTabAnalysisBinding>(
    ...
    private fun updateCategoryDisplay() {
        ...
        binding.textViewCategory.text = if (selectedIds.isNullOrEmpty()) {
            getString(R.string.text_all_expense_categories)
        } else {
    ...
    private fun updateUI(data: AnalysisData) {
        binding.apply {
            ...
            labelAverageExpense.text = when (tabType) {
                TabType.NOW -> getString(R.string.text_average_spending_day)
                TabType.MONTHLY -> getString(R.string.text_average_spending_month)
                TabType.YEAR -> getString(R.string.text_average_spending_year)
                else -> getString(R.string.text_average_spending_month)
            }
