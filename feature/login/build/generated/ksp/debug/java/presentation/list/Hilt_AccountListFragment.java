...
public abstract class Hilt_AccountListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AccountListFragment() {
    super();
  }

  Hilt_AccountListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccountListFragment_GeneratedInjector) this.generatedComponent()).injectAccountListFragment(UnsafeCasts.<AccountListFragment>unsafeCast(this));
    }
  }
